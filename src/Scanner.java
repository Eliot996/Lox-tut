...
class Scanner {
    ...
    private void scanToken() {
        ...
        switch (c) {
            ...
            case '(' -> addToken(TokenType.LEFT_PARAN);
            case ')' -> addToken(TokenType.RIGHT_PARAN);
            ...
            // increment line for new line char
            case '\n'-> line++;
    ...
    private void number() {
         // continue adding if numbers
         while (isDigit(peek())) advance();

         // add dot if found, and keep adding numbers
